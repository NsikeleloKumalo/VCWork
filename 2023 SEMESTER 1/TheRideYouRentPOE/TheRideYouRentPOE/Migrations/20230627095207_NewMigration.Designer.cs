...
namespace TheRideYouRentPOE.Migrations
{
    ...
    [Migration("20230627095207_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.CarBodyType", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.CarMake", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.Driver", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.Inspector", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.Rental", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.ReturnCar", b =>
                {
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.Rental", b =>
                {
                    b.HasOne("TheRideYouRentPOE.Models.Car", "CarNoNavigation")
                        .WithMany("Rental")
                        .HasForeignKey("CarNo")
                        .IsRequired()
                        .HasConstraintName("FK__Rental__CarNo__6D0D32F4");

                    b.HasOne("TheRideYouRentPOE.Models.Driver", "Driver")
                        .WithMany("Rental")
                        .HasForeignKey("DriverId")
                        .IsRequired()
                        .HasConstraintName("FK__Rental__Driver_I__6EF57B66");

                    b.HasOne("TheRideYouRentPOE.Models.Inspector", "InspectorNoNavigation")
                        .WithMany("Rental")
            ...
            modelBuilder.Entity("TheRideYouRentPOE.Models.ReturnCar", b =>
                {
                    ...
                    b.HasOne("TheRideYouRentPOE.Models.Rental", "RentalNoNavigation")
                        .WithMany("ReturnCar")
