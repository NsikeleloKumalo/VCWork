...
namespace POETheRideYouRent.Migrations
{
    ...
    [Migration("20230627091137_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.CarBodyType", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.CarMake", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.Driver", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.Inspector", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.Rental", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.ReturnCar", b =>
                {
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.Rental", b =>
                {
                    b.HasOne("POETheRideYouRent.Models.Car", "CarNoNavigation")
                        .WithMany("Rental")
                        .HasForeignKey("CarNo")
                        .IsRequired()
                        .HasConstraintName("FK__Rental__CarNo__6D0D32F4");

                    b.HasOne("POETheRideYouRent.Models.Driver", "Driver")
                        .WithMany("Rental")
                        .HasForeignKey("DriverId")
                        .IsRequired()
                        .HasConstraintName("FK__Rental__Driver_I__6EF57B66");

                    b.HasOne("POETheRideYouRent.Models.Inspector", "InspectorNoNavigation")
                        .WithMany("Rental")
            ...
            modelBuilder.Entity("POETheRideYouRent.Models.ReturnCar", b =>
                {
                    ...
                    b.HasOne("POETheRideYouRent.Models.Rental", "RentalNoNavigation")
                        .WithMany("ReturnCar")
